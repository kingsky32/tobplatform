...
<section id="bo_w">
    ...
    <div class="bo_w_flie write_div">
        <div class="file_wr write_div">
            <label for="bf_file_1" class="lb_icon">Thumb</label>
    ...
    <div class="bo_w_flie write_div">
        <div class="file_wr write_div">
            <label for="bf_file_2" class="lb_icon">Top Background</label>
    ...
    <div class="bo_w_flie write_div">
        <div class="file_wr write_div">
            <label for="bf_file_3" class="lb_icon">Logo</label>
            <input type="file" name="bf_file[]" id="bf_file_3" title="파일첨부 3 : 용량 <?php echo $upload_max_filesize ?> 이하만 업로드 가능" class="frm_file ">
        </div>
        <?php if ($is_file_content) { ?>
        <input type="text" name="bf_content[]" value="<?php echo ($w == 'u') ? $file[2]['bf_content'] : ''; ?>" title="파일 설명을 입력해주세요." class="full_input frm_input" size="50" placeholder="파일 설명을 입력해주세요.">
        <?php } ?>
    ...
    <?php for ($i=3; $is_file && $i<$file_count; $i++) { ?>
    <div class="bo_w_flie write_div">
        <div class="file_wr write_div">
